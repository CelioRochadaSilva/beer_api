...
public class BeerServiceTest {
    ...
    void whenBeerInformedThenItShouldBeCreated() throws BeerAlreadyRegisteredException {
        ...
        //when
        OngoingStubbing<java.util.Optional<Beer>> optionalOngoingStubbing = when(beerRepository.findByName(expectedBeerDTO.getName())).thenReturn(java.util.Optional.empty());
